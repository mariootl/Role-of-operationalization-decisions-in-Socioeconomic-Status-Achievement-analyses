...
################################################################
# Data wrangling CHILE
################################################################
##############
# Loading the data
##############
# CHILE COUNTRY SPECIFC WEALTH INDICATORS
# F=DOMESTIC HELP | G=SHOWER WITH HOT WATER | h=DISHWASHER | I=MORE THAN ONE BATHROOM

lab.Base = c("IDSCHOOL","IDCLASS","IDSTUD","TOTWGT","JKZONE","JKREP","BSSSCI01","BSSSCI02","BSSSCI03","BSSSCI04","BSSSCI05")
lab.HomeR = c("BSBG05A","BSBG05B","BSBG05C","BSBG05D","BSBG05E","BSBG05F","BSBG05G","BSBG05H","BSBG05I")
lab.SES <- c("BSBG04","BSBG06A","BSBG06B","BSBGHER","BSDGHER")
lab.HERIndex <- c(lab.HomeR, "BSBG04", "BSBG06C")
data <- read.spss("bsgchlm7.sav", to.data.frame=TRUE, max.value.labels=7)
...
#write.csv2(TableOfNAs,file = "table_of_NA_Chile.csv")

# There are 30 cases where non of the indicators for the home possessions, books at home and highiest education of a parent.  
...
multiverse_rules_cluster1 <- list(
  ...
  list(name = "BSBG05_Score_MV1", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = 1, high_levels = c(2, 3, 4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV2", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2), high_levels = c(3, 4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV3", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3), high_levels = c(4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV4", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3, 4), high_levels = c(5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV5", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3, 4, 5), high_levels = c(6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV6", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3, 4, 5, 6), high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV7", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3, 4, 5, 6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV8", variable = "BSBG05_Possessions_Score", low_levels = 0, medium_levels = c(1, 2, 3, 4, 5, 6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV9", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = 2, high_levels = c(3, 4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV10", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3), high_levels = c(4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV11", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3, 4), high_levels = c(5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV12", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3, 4, 5), high_levels = c(6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV13", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3, 4, 5, 6), high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV14", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3, 4, 5, 6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV15", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1), medium_levels = c(2, 3, 4, 5, 6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV16", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = 3, high_levels = c(4, 5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV17", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = c(3, 4), high_levels = c(5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV18", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = c(3, 4, 5), high_levels = c(6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV19", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = c(3, 4, 5, 6), high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV20", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = c(3, 4, 5, 6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV21", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2), medium_levels = c(3, 4, 5, 6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV22", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3), medium_levels = 4, high_levels = c(5, 6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV23", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3), medium_levels = c(4, 5), high_levels = c(6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV24", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3), medium_levels = c(4, 5, 6), high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV25", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3), medium_levels = c(4, 5, 6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV26", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3), medium_levels = c(4, 5, 6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV27", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4), medium_levels = 5, high_levels = c(6, 7, 8, 9)),
  list(name = "BSBG05_Score_MV28", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4), medium_levels = c(5, 6), high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV29", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4), medium_levels = c(5, 6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV30", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4), medium_levels = c(5, 6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV31", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5), medium_levels = 6, high_levels = c(7, 8, 9)),
  list(name = "BSBG05_Score_MV32", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5), medium_levels = c(6, 7), high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV33", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5), medium_levels = c(6, 7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV34", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5, 6), medium_levels = 7, high_levels = c(8, 9)),
  list(name = "BSBG05_Score_MV35", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5, 6), medium_levels = c(7, 8), high_levels = 9),
  list(name = "BSBG05_Score_MV36", variable = "BSBG05_Possessions_Score", low_levels = c(0, 1, 2, 3, 4, 5, 6, 7), medium_levels = 8, high_levels = 9)
)

ordered_multiverse_ids_cluster1 <- sapply(multiverse_rules_cluster1, `[[`, "name")

### WE HAVE IN TOTAL 60 MULTIVERSES IN CHILE
...
BSBG06CDescri <- pool_descriptives(DataImp,"BSBG05_Possessions_Score"); BSBG06CDescri

#########
# Overall descriptives
#########

DescriptivesChile <- data.frame(
  variable=c("BSBG04","BSBG06C","BSBG05Possession_Score"),
  Mean=c(2.2328,4.3496,6.1956),
  Median=c(2,5,6),
  sd=c(1.1547,1.7011,1.4996),
  Skewness=c(0.7810,0.0089,-0.5494)
);DescriptivesChile
#write.csv2(DescriptivesChile,"DescriptivesChile.csv")
...
# MULTIVERSE Ed_MV10 L=1,2,3|M=4|H=5,6,7 has 0% of respondents in medium SES, so it will be removed 
# (position 187 in the all_gap_results object)

####
# Eliminating that multiverse
###

all_gap_results

########################
# Function to pool gaps
#######################
...
if (length(all_gap_results) > 0) {
  ...
  # Filter out groups that have too few valid data points before pooling
  pooled_gap_results <- raw_gap_data %>%
    # Remove any rows with NA values first
    filter(!is.na(Gap_Value), !is.na(Std_Error)) %>%
    # Group the data to count the number of valid rows per group
    group_by(Multiverse_ID, Gap_Type) %>%
    # Filter groups that have at least 2 valid estimates for pooling
    filter(n() >= 2) %>%
    # Now, perform the pooling on the filtered, valid groups
    summarise(
...
# Plot Gaps
#############################
multiverse_rules_cluster1 <- multiverse_rules_cluster1[
  !sapply(multiverse_rules_cluster1, function(rule) rule$name == "BSBG06C_MV10")
]
...
# 1.2 : Create Decision Table Data to generate Color_Key
create_decision_data <- function(multiverse_rules_cluster1, labels_df) {
...
if (exists("pooled_r2_results") && nrow(pooled_r2_results) > 0) {
  ...
  # Check what multiverse IDs you actually have in your Chile data
  cat("Multiverse IDs in Chile data:\n")
  print(sort(unique(pooled_r2_results$Multiverse_ID)))
  
  # Step 1: Create the custom order for Chile multiverses (fixed naming)
  multiverse_order <- c(
    # BSBG04 (Books at Home)
    ...
    # BSBG05_Score (Home Possessions) - FIXED: consistent naming without "SES_" prefix
    ...
    "BSBG05_Score_MV21", "BSBG05_Score_MV22", "BSBG05_Score_MV23", "BSBG05_Score_MV24", "BSBG05_Score_MV25",
    "BSBG05_Score_MV26", "BSBG05_Score_MV27", "BSBG05_Score_MV28", "BSBG05_Score_MV29", "BSBG05_Score_MV30",
    "BSBG05_Score_MV31", "BSBG05_Score_MV32", "BSBG05_Score_MV33", "BSBG05_Score_MV34", "BSBG05_Score_MV35",
    "BSBG05_Score_MV36"
  )
  
  # Step 2: Filter the multiverse_order to only include IDs that exist in your data
  ...
  # Step 3: Create the plot data and set the factor levels
  plot_data <- pooled_r2_results %>%
    mutate(
      ...
      # Use the filtered order that matches your actual data
      Multiverse_ID = factor(Multiverse_ID, levels = multiverse_order_filtered)
    )
  
  # Step 4: Check for any missing multiverses
  missing_multiverses <- setdiff(actual_multiverse_ids, multiverse_order_filtered)
  if (length(missing_multiverses) > 0) {
    cat("Warning: These multiverse IDs were not in the ordering list:\n")
    print(missing_multiverses)
  }
...
final_plot <- r2_plot / decision_plot +
  plot_layout(heights = c(3, 1))
